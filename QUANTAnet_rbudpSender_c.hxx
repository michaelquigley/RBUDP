 ...
 * RBUDP Sender class.
 *
 * This class implements the sender part of RBUDP protocol. First, instantiate the QUANTAnet_rbudpSender_c class. Then
 * call this object's init() method with the host name or IP address of the receiver as parameter. This is a blocking
 * call that waits for the receiver to make to init() call to connect to the sender. After that, you can call this
 * object's send(buffer, sizeofBuffer, sendRate, sizeofPacket) to send a buffer.  After you finish sending all buffers,
...
public:
    ...
    */
    ...
    /** Send a data stream from a UNIX file descriptor to the receiver using RBUDP protocol.
        @param fromfd the file descriptor to fetch data from
        @param sendRate the first-pass UDP blasting rate in Kbps.
        @param packetSize payload size of each UDP packet.
        @param bufSize data is sent in this-size chunks
    */
